    ...
    <ThemeProvider theme={defaultTheme}>
       ...
       sx={{
        ...
        <Box sx={{
          ...
          <Typography sx={{ fontSize:'12px',position: "absolute", top: "10px", left: "10px" }}>CheckListMedicalDevice</Typography>
          <img style={{ height: 45, width: "auto", borderRadius: 90, position: "absolute", top: "10px", right: "10px" }} src={Chiwa} alt='logo' />
